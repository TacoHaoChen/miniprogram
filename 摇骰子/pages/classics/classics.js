...
var e, a, o = getApp(), i = 400, s = !1, l = wx.getSystemInfoSync(), n = 1210 / 750 * l.windowWidth, r = void 0, d = void 0, c = [], h = [ "加个微信吧!", "我喜欢你!", "单身可撩!", "需要让座请叫我" ], u = -1, x = "", m = !1, f = "", v = null;
...
Page({
    ...
    documentClick: function() {
        var t = this;
        clearTimeout(a);
        var e = this.data.hideLock, o = this.data.lockOff;
    ...
    scorllText: function() {
        this.clearText();
        var t = "", a = this, o = wx.createSelectorQuery();
    ...
    check: function(t, e) {
        ...
        "" != t ? wx.cloud.callFunction({
            ...
            if (console.log(t.result), 300 == t.result.code) return wx.showToast({
                title: "内容不合法",
    ...
    effectControl: function(t) {
        this.clearText();
        var e = t.currentTarget.dataset.variable, a = t.currentTarget.dataset.index, o = this.data.textStyle[a];
